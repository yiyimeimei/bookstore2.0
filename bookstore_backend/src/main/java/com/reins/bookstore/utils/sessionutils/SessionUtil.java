    ...
    public static JSONObject getState() {
        ...
        if (requestAttributes != null) {
            ...
            if (session != null) {
                ...
                stateObject.put("userId", session.getAttribute("userId"));
                stateObject.put("username", session.getAttribute("username"));
                stateObject.put("userState", session.getAttribute("userState"));
                return stateObject;
            }
        }
        return null;
